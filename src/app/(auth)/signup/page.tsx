      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-blue-100 mb-8">
            Join thousands of professionals who trust ResumeAI to create 
            stunning resumes that land interviews.
          </p>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
            <p className="italic text-blue-100">
              &ldquo;ResumeAI helped me land my dream job at a Fortune 500 company. 
              The templates are beautiful and the editor is so easy to use!&rdquo;
            </p>
